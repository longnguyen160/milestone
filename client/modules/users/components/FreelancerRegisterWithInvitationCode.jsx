          ...
          <div id="Card">
              ...
              <form className="centerlize">
                  ...
                  <div className="checkbox">
                    {error[4] === true ? <label><input ref="checkbox" checked onChange={this.checkCheckedBox.bind(this)} ref="checkbox" type="checkbox" /> I agree to the <a href="/">terms of service</a></label>
